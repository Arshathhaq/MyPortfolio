...
const aboutMe = {
  ...
  "terminal": {
    "whoami": "SOC & Incident Response | SIEM | Penetration Testing | Application & Network Security | ML for Security",
    "education": [
  ...
  "skills": [
    { "icon": "fas fa-flag", "label": "CTF" },
    { "icon": "fas fa-code", "label": "Scripting" },
